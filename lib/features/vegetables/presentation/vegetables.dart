          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  color: Colors.red,
                  fontSize: 30.sp, // Use .sp for scaling text size
                  fontWeight: FontWeight.bold,
                ),
              ),
              UIHelper.verticalSpace(15.h),

              // Custom TextForm Widget for search input
              CustomTextFormWiget(
                  ...
                  itemBuilder: (context,index) {
                    return    Row(
                      ...
                      children: [
                        ...
                        Padding(
                          padding:
                          EdgeInsets.symmetric(horizontal: 8.0.w, vertical: 22.h),
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(
                                ...
                                style: TextFontStyle.c2D0C57w600
                                    .copyWith(color: Color(0xffc2D0C57),fontSize: 15.sp),
                              ),
