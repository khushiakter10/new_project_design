...
import '../features/app_aducation/presentation/lesson_screen.dart';
...
final class RouteGenerator {
 ...
 case Routes.lesson_Screen:
        return Platform.isAndroid
            ? _FadedTransitionRoute(widget: const Lesson_Screen(), settings: settings)
            : CupertinoPageRoute(builder: (context) => const Lesson_Screen());
